...
visual_locale = os.environ.get("BEACON_SMOKE_VISUAL_LOCALE", "")
if visual_locale:
    payload["BEACON_SMOKE_VISUAL_LOCALE"] = visual_locale

visual_query = os.environ.get("BEACON_SMOKE_VISUAL_QUERY", "")
if visual_query:
    payload["BEACON_SMOKE_VISUAL_QUERY"] = visual_query

visual_only = os.environ.get("BEACON_SMOKE_VISUAL_ONLY", "")
if visual_only:
    payload["BEACON_SMOKE_VISUAL_ONLY"] = visual_only
...
visual_locale = os.environ.get("BEACON_SMOKE_VISUAL_LOCALE", "")
if visual_locale:
    payload["visualLocale"] = visual_locale

visual_query = os.environ.get("BEACON_SMOKE_VISUAL_QUERY", "")
if visual_query:
    payload["visualQuery"] = visual_query

visual_only = os.environ.get("BEACON_SMOKE_VISUAL_ONLY", "")
if visual_only:
    payload["visualOnly"] = visual_only.lower() in {"1", "true", "yes"}
